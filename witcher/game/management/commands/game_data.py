...
''',
        'actions': {' Взять трофей. Отправиться в деревню за наградой.': (26, None, 'troll_dead')},
    },
    {
        'name': '7',
...
выл староста. 
''',
        'actions': {'Вывести старосту на улицу и рассказать о том, что староста пользовался спившимся троллем, а все убийства и грабежи прохожих лежат насовести Бориса]( Геральт останется без денег) ': (10, 'note'),
...
''',
    ...
    },
    {
        'name': '21',
        'message': '''''',
        'actions': {'Рассказать троллю о записке': (3, None, 'troll_side'),
