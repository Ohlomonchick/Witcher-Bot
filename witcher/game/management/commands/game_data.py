...
Продовольствия хватило, чтобы добраться до Новиграда. Как оказалось, барахло было
ценным, Геральт выручил за него неплохие деньги.
...
учёбы в Оксенфурте, но всё-же, постарайся ему не навредить, не хочу проблем в профессорском обществе.
...
за письменным столом, корпеющего над листом бумаги, это, по видимому, и был Прометиций. 
В доме явно не было место для склада зелий да и рун Геральт не чувствовал по-близости. 
''',
...
Геральт подошёл к дверям амбара и обнаружел, что на них лежит руна, не дающая проходу.\n
...
Уравняйте химическую реакцию и введите сумму коэффициэнтов в правой части уравнения.
